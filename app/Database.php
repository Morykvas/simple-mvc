...
class Database 
{
    ...
    public function __construct() 
    {
        ...
        try {
            ...
            echo "Помилка з'єднання з базою даних: " . $e->getMessage() . $e->getLine();
            die();
        }
    }
    ...
    {
        try {
           $stmt = $this->pdo->prepare("SELECT products.product_name, products.product_description, products.product_price,  categories.category_name FROM products JOIN categories ON products.category_id = categories.category_id WHERE categories.category_name = :category");
